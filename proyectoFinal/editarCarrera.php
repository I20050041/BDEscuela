...
<body>
    <form class="formulario" method="get" action="carreraEditar.php">
    ...
    <?php
     ...
     <div class="input-contenedor text-center">
         ...
         <?php
            echo '<input type="text" name="txtCantidadSemestres" class ="input" placeholder="Cantidad Semestres" value="'.$cantidad.'">'
            ?>        
         </div>
         <div class="input-contenedor text-center">
         ...
         <a class="bx bx-log-out" href="carreraEditar.php"></a>
